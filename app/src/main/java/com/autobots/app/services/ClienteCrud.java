...
public class ClienteCrud implements CrudInterface<Cliente, Long, ClienteAtualizadorDTO> {
    ...
    public List<Documento> selecionarDocumentos(Long id) {
        Cliente clienteAlvo = clienteRepositorio.findById(id).get();
        return clienteAlvo.getDocumentos();
    }
    ...
    public List<Telefone> selecionarTelefones(Long id) {
        Cliente clienteAlvo = clienteRepositorio.findById(id).get();
        return clienteAlvo.getTelefones();
    }
