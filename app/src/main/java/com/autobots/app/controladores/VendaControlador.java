...
public class VendaControlador {
    ...
    public ResponseEntity<?> adicionar(@RequestBody VendaDTO novaVenda) {
        try {
            ...
            VendaReturnDTO venda = vendaCrud.inserir(novaVenda, requester);
    ...
    public ResponseEntity<?> selecionar(@PathVariable Long id) {
        try {
            ...
            VendaReturnDTO venda = vendaCrud.selecionar(id, requester);
            adicionarLinks.adicionarLink(venda);
            return ResponseEntity.ok(venda);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    public ResponseEntity<?> selecionarFromUsuario(@PathVariable Long idUsuario) {
        try {
            ...
            List<VendaReturnDTO> vendas = vendaCrud.selecionarFromUsuario(idUsuario, requester);
            adicionarLinks.adicionarLink(vendas);
            return ResponseEntity.ok(vendas);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    public ResponseEntity<?> selecionarFromEmpresa(@PathVariable Long idEmpresa) {
        try {
            ...
            List<VendaReturnDTO> vendas = vendaCrud.selecionarFromUsuario(idEmpresa, requester);
            adicionarLinks.adicionarLink(vendas);
            return ResponseEntity.ok(vendas);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
    ...
    public ResponseEntity<?> deletar(@PathVariable Long id) {
        try {
            ...
            vendaCrud.deletar(id, requester);
